...
def render_vacation(year: int) -> None:
    ...
    body += (
        ...
        f'poster="img/poster-emenda-br-{year}.jpg">'
        f'<source src="video/emenda-br-{year}.mp4" type="video/mp4"></video>'
        '<figcaption>Corpus Christi cai sempre numa quinta-feira. Emendando a sexta, uma única folga cobre de quinta a domingo. A sexta não é feriado: depende do seu empregador.</figcaption>'
        '</figure></div></section>'
    )
